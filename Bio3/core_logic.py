...
# === 2. Модуль Нормализации (Geometry Engine) ===
...
# === 3. Модуль Аудита Аномалий (Anomaly Auditor) ===
class AnomalyAuditor:
    ...
    def compute_feature_vector(self, kps: Dict, state: PersonState, geometry: GeometryEngine) -> Dict[str, Any]:
        ...
        feature_vector = {
            ...
            "bbox_height_px": features['bbox_height_px'] # Для отладки
        }
